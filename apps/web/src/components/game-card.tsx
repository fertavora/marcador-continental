...
export function GameCard({ game }: { game: Game }) {
  ...
  return (
    <Link href={`/juego/${game.id}`} data-testid={`game-card-${game.id}`}>
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2">
              <Badge
                ...
                data-testid={`game-card-status-${game.id}`}
              >
              ...
              <div onClick={(e) => e.stopPropagation()}>
                <AlertDialog>
                  <AlertDialogTrigger
                    render={
                      <Button
                        ...
                        data-testid={`game-card-delete-trigger-${game.id}`}
                  ...
                  <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                      <AlertDialogCancel data-testid={`game-card-delete-cancel-${game.id}`}>
                        Cancelar
                      </AlertDialogCancel>
                      <AlertDialogAction
                        variant="destructive"
                        data-testid={`game-card-delete-confirm-${game.id}`}
